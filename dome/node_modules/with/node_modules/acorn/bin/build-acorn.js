...
browserify({standalone: "acorn"})
  ...
  .transform(babelify)
  .require("./src/controller.js", {entry: true})
  .bundle()
...
function acornShim(file) {
  ...
  if (file == path.resolve(__dirname, "../src/controller.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(acornShim)
  .transform(babelify)
  .require("./src/loose/controller.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShim)
  .transform(babelify)
  .require("./src/walk/controller.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
